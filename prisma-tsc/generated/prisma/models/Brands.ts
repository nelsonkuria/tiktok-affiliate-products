...
export type BrandsWhereInput = {
  ...
  id?: Prisma.StringFilter<"Brands"> | string
  tiktokId?: Prisma.StringFilter<"Brands"> | string
  name?: Prisma.StringFilter<"Brands"> | string
  avatar?: Prisma.StringFilter<"Brands"> | string
  regions?: Prisma.StringNullableListFilter<"Brands">
  createdAt?: Prisma.DateTimeFilter<"Brands"> | Date | string
  updatedAt?: Prisma.DateTimeFilter<"Brands"> | Date | string
}
...
export type BrandsScalarWhereWithAggregatesInput = {
  ...
  id?: Prisma.StringWithAggregatesFilter<"Brands"> | string
  tiktokId?: Prisma.StringWithAggregatesFilter<"Brands"> | string
  name?: Prisma.StringWithAggregatesFilter<"Brands"> | string
  avatar?: Prisma.StringWithAggregatesFilter<"Brands"> | string
  regions?: Prisma.StringNullableListFilter<"Brands">
  createdAt?: Prisma.DateTimeWithAggregatesFilter<"Brands"> | Date | string
  updatedAt?: Prisma.DateTimeWithAggregatesFilter<"Brands"> | Date | string
}
...
export type BrandsCreateInput = {
  ...
  name: string
  avatar: string
  regions?: Prisma.BrandsCreateregionsInput | string[]
...
export type BrandsUpdateInput = {
  ...
  regions?: Prisma.BrandsUpdateregionsInput | string[]
...
export type BrandsCreateregionsInput = {
  set: string[]
}

export type BrandsUpdateregionsInput = {
  set?: string[]
  push?: string | string[]
}
...
export type BrandsOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "tiktokId" | "name" | "avatar" | "regions" | "createdAt" | "updatedAt", ExtArgs["result"]["brands"]>
...
export interface BrandsFieldRefs {
  ...
  readonly tiktokId: Prisma.FieldRef<"Brands", 'String'>
  readonly name: Prisma.FieldRef<"Brands", 'String'>
  readonly avatar: Prisma.FieldRef<"Brands", 'String'>
  readonly regions: Prisma.FieldRef<"Brands", 'String[]'>
  readonly createdAt: Prisma.FieldRef<"Brands", 'DateTime'>
  readonly updatedAt: Prisma.FieldRef<"Brands", 'DateTime'>
}
